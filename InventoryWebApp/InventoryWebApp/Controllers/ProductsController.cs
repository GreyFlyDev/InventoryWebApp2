...
namespace InventoryWebApp.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var products = db.Products.Where(p => p.UserId.Contains(currentUser));
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,Quantity,PurchasePricePerUnit,SalePricePerUnit,NumberOfSales,UserId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,Quantity,PurchasePricePerUnit,SalePricePerUnit,NumberOfSales,UserId")] Product product)
        {
            if (ModelState.IsValid)
            {
